...
//      forge script script/ProteinMango.s.sol:PrepareAttestationRequest --rpc-url $COSTON2_RPC_URL --ffi
...
//      forge script script/ProteinMango.s.sol:SubmitAttestationRequest --rpc-url $COSTON2_RPC_URL --etherscan-api-key $FLARE_API_KEY --broadcast --ffi
...
//      forge script script/ProteinMango.s.sol:RetrieveDataAndProof --private-key $PRIVATE_KEY --rpc-url $COSTON2_RPC_URL --etherscan-api-key $FLARE_API_KEY --broadcast --ffi
